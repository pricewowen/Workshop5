...
/**
 * Generate SQL INSERT statements with BCrypt hashed passwords for staff accounts.
 * Run this class and copy the output SQL into your MySQL client.
 *
 * This app is staff-only (Admin + Employee). No customer login accounts are needed.
 * Customers are data records managed by staff through the Customers CRUD view.
 */
public class GenerateTestUserSQL {

    public static void main(String[] args) {
        System.out.println("=== Generate Test Staff Users SQL with BCrypt Hashes ===\n");
        ...
        System.out.println("-- DELETE FROM `User` WHERE userUsername IN ('admin', 'employee1', 'manager');\n");

        // Staff-only test users
        String[][] users = {
        ...
        System.out.println("-- Test Staff Users (Generated: " + java.time.LocalDateTime.now() + ")");
